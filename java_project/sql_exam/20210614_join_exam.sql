...
where e.mgr = m.empno
;
--OUTER JOIN, SELF JOIN을 사용하여 관리자가 없는 사원을 포함하여
...
--이름, 부서번호, 지정한 사원과 동일한 부서에서 근무하는 사원을 출력하시오. ( SCOTT )
...
from emp e, emp m
where m.hiredate > e.hiredate and e.ename = 'WARD'
;
--SELF JOIN 을 사용하여 관리자보다 먼저 입사한 모든 사원의
