...
public class CarManager {
	...
	void CarList() {
		...
		try {
			...
			System.out.println("------------------");
			System.out.println("코드번호\t차번호\t차이름 \t차크기\t탑승인원 \t연식\t연료\t대여현황");
			System.out.println("(대여현황 0 이면 렌트가능 1이면 렌트 불가)");
			System.out.println("--------------------------------------------------");
	...
	void inputCarData() {
		...
		try {
			...
			Car car = new Car(0, cardata[0], cardata[1], cardata[2], Integer.parseInt(cardata[3]),
					Integer.parseInt(cardata[4]), cardata[5], cardata[6]);
	...
	void editCar() {
		...
		try {
			...
			System.out.println("차량의 크기를 입력하세요");
			String carsize = sc.nextLine();
			System.out.println("탑승가능 인원을 입력하세요");
			int carseat = sc.nextInt();
			System.out.println("차량 연식을 입력하세요");
			int caryear = sc.nextInt();
			System.out.println("차량의 연료를 입력하세요");
			sc.nextLine();
			...
			int result = Cdao.editCar(conn, carnumber, carname, carsize, carseat, caryear, fuel, carcode);
...
//			String rent = sc.nextLine();
			...
			int result = Cdao.rentCar(conn, carnumber);
...
//			 String carnumber = sc.nextLine();
			...
			int result = Cdao.returnCar(conn, carnumber);
