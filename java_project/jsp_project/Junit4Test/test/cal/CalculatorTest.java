...
public class CalculatorTest {
	...
	public void testMultiply() {
		...
		assertEquals("mutliply() 메소드 테스트", 20, cal.multiply(10, 2));
		//fail("Not yet implemented");
	...
	public void test3() {
		...
		//assertNull("메소드의 실행 값이 null이 예상되는경우", new Object());
		//assertNotNull("메소드의 실행 값이 null이 아닌 값이 예상되는경우", null);
		//assertSame("같은 값일 경우", 1, 2); 
		assertNotSame("같은 값일 경우 ", 1, 1);
		assertTrue("메소드의 반환값이 true가 예상될때 ", false);
	}
