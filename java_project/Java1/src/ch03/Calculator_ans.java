...
//	④ 정수 두 개를 매개변수의 인자로 전달받아 나누기연산 후 출력하는 메소드를 정의
	float div(int num1 , int num2) {
		return (float)num1/num2;  // (float)int/int -> in6t
	}
...
//	원의 둘레 : 2 x π x r , 월의 넓이 : π x r x r
	...
	public static void main(String[] args) {
		...
		Calculator_ans cal2 = new Calculator_ans();
		
		System.out.println(cal2.PI);
		System.out.println("1 + 2 = " + cal2.plus(1,2));
		...
		System.out.println("입력 받은 반지름의 길이는 : " + r );
		System.out.println("원의 둘레는 : " + cal2.circum(r));
		System.out.println("원의 넓이는 : " + cal2.cirArea(r));
	}
